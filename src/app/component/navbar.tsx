        ...
        <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
          <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            <Image
              ...
              width={100}
              height={100}
              className="w-[50px] rounded-full outline outline-blue-950 "
            />
          ...
          <a href="/assests/cv/1.pdf">
            <button className="  inline-flex items-center bg-blue-100 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0 ">
              Download CV
